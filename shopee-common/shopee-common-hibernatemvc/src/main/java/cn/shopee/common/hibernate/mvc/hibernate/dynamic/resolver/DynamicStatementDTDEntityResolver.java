package cn.shopee.common.hibernate.mvc.hibernate.dynamic.resolver;
...
public class DynamicStatementDTDEntityResolver implements EntityResolver, Serializable {
	...
	private static final String HOP_DYNAMIC_STATEMENT = "http://www.shopee.cn/dtd/";
	...
	private InputSource resolveOnClassPath(String publicId, String systemId, String namespace) {
		...
		String path = "cn/shopee/core/common/hibernate/dynamic/dtd/" + systemId.substring(namespace.length());
