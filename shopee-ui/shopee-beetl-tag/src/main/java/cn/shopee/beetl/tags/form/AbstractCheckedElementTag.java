...
public abstract class AbstractCheckedElementTag extends AbstractHtmlInputElementTag {
	 ...
	 * through delegating to {@link cn.shopee.beetl.tags.form.SelectedValueComparator#isSelected}.
	 */
	private boolean isOptionSelected(Object value) throws BeetlTagException {
		return cn.shopee.beetl.tags.form.SelectedValueComparator.isSelected(getBindStatus(), value);
	}
