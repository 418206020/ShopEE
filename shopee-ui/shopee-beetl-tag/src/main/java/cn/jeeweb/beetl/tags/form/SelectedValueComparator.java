...
import cn.shopee.beetl.tags.form.ValueFormatter;
...
abstract class SelectedValueComparator {
	...
	private static boolean exhaustiveCompare(Object boundValue, Object candidate,
		...
		String candidateDisplayString = cn.shopee.beetl.tags.form.ValueFormatter.getDisplayString(candidate, editor, false);
