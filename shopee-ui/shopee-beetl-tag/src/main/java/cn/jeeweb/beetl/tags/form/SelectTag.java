...
import cn.shopee.beetl.tags.support.BindStatus;
...
public class SelectTag extends AbstractHtmlInputElementTag {
	 ...
	 * which the bound value is exposed to inner {@link cn.shopee.beetl.tags.form.OptionTag OptionTags}.
	 */
	public static final String LIST_VALUE_PAGE_ATTRIBUTE =
			"cn.shopee.beetl.tags.form.SelectTag.listValue";
	 ...
	 * <p>Only used in conjunction with nested {@link cn.shopee.beetl.tags.form.OptionTag OptionTags}.
	 */
	 ...
	 * bound value for the nested {@link cn.shopee.beetl.tags.form.OptionTag OptionTags}.
	 */
	@Override
	 ...
	 * nested {@link cn.shopee.beetl.tags.form.OptionTag options}.
	 */
	@Override
